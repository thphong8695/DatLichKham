...
<div class="page-header">
    ...
    <div class="page-rightheader ml-auto d-lg-flex d-none">
        <div class="btn-group mb-0">
                <a type="button" href="{{ route('benh-vien.create') }}" class="btn btn-success"><i class="fa fa-plus mr-2"></i>Tạo mới</a>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table id="example" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th> TÊN BỆNH VIỆN - PHÒNG KHÁM </th>
                            <th> SLUG </th>
                            <th>TRẠNG THÁI</th>
                    ...
                    <tbody>
                       @foreach($benhvien as $value)
                        <tr>
                            ...
                            @can('DlBv106x-delete')
                            <td>
                                <a class="btn btn-primary" href="{{ route('benh-vien.edit',$value->id) }}">Edit</a>
                                {!! Form::open(['method' => 'DELETE','route' => ['benh-vien.destroy', $value->id],'style'=>'display:inline']) !!}
