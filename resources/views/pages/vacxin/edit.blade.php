...
<div class="page-header mt-3">
    <div class="page-leftheader">
        ...
        <ol class="breadcrumb pl-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('vac-xin.index') }}">Danh sách bệnh vắc-xin</a></li>
            <li class="breadcrumb-item active" aria-current="page">Sửa vắc-xin</li>
        </ol>
    </div>
    ...
    <div class="col-md-12 col-lg-12">  
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::model($vacXin, ['method' => 'PATCH','route' => ['vac-xin.update', $vacXin->id]]) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('ngayapdung', $vacXin->ngayapdung->format('d-m-Y'), array('placeholder' => 'Ngày áp dụng','class' => 'form-control','data-toggle' => 'datepicker','autocomplete' => 'off')) !!}
                                @error('ngayapdung')
                                    <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="colorinput">
                                    <input name="mienphi" value="1" type="checkbox"  class="colorinput-input" {{ $vacXin->mienphi == 1 ? 'checked' :'' }} />
