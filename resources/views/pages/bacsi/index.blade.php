...
<div class="page-header">
    <div class="page-leftheader">
        <h4 class="page-title"><a href="{{ route('bac-si.index') }}">Dữ liệu bác sĩ</a></h4>
    ...
    <div class="page-rightheader ml-auto d-lg-flex d-none">
        <div class="btn-group mb-0">
                <a type="button" href="{{ route('bac-si.create') }}" class="btn btn-success"><i class="fa fa-plus mr-2"></i>Tạo mới</a>
...
<div class="row">
    <div class="col-md-12">  
        <div class="card">
            {!! Form::open(array('route' => 'bac-si.index','method'=>'get')) !!}
                ...
                <table id="example" class="table table-striped table-bordered">
                    ...
                    <tbody>
                       @foreach($bacsi as $value)
                        <tr>
                            <td>{{ $value->name }}</td>
                            <td>{{ $value->ChuyenKhoa->name }}</td>
                            <td>{{ $value->BenhVienPK->name }}</td>
                            @can('DlBv106x-delete')
                            <td>
                                <a class="btn btn-primary" href="{{ route('bac-si.edit',$value->id) }}">Edit</a>
                                {!! Form::open(['method' => 'DELETE','route' => ['bac-si.destroy', $value->id],'style'=>'display:inline']) !!}
