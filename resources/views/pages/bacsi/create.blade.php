...
<div class="page-header mt-3">
    <div class="page-leftheader">
        ...
        <ol class="breadcrumb pl-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('bac-si.index') }}">Danh sách bác sĩ</a></li>
            <li class="breadcrumb-item active" aria-current="page">Tạo mới bác sĩ</li>
        </ol>
    </div>
    ...
    <div class="col-md-12 col-lg-12">  
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(array('route' => 'bac-si.store','method'=>'POST')) !!}
