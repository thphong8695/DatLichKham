...
<div class="page-header">
    <div class="page-leftheader">
        <h4 class="page-title"><a href="{{ route('tuychinh-khunggio.index') }}">Dữ liệu tùy chỉnh Khung giờ</a></h4>
    ...
    <div class="page-rightheader ml-auto d-lg-flex d-none">
        <div class="btn-group mb-0">
                <a type="button" href="{{ route('tuychinh-khunggio.create') }}" class="btn btn-success"><i class="fa fa-plus mr-2"></i>Tạo mới</a>
...
<div class="row">
    <div class="col-md-12">  
        <div class="card">
            {!! Form::open(array('route' => 'tuychinh-khunggio.index','method'=>'get')) !!}
            ...
            <div class="card-body">
                ...
                <table id="example" class="table table-striped table-bordered">
                    ...
                    <tbody>
                       @foreach($tuychinhkg as $key=>$value)
                        <tr>
                            <td>{{ $value->ngaydat->format('d/m/Y') }}</td>
                            <td>{{ $value->soluong }}</td>
                            ...
                            @can('DlBv106x-delete')
                            <td>
                                <a class="btn btn-primary" href="{{ route('tuychinh-khunggio.edit',$value->id) }}">Edit</a>
                                {!! Form::open(['method' => 'DELETE','route' => ['tuychinh-khunggio.destroy', $value->id],'style'=>'display:inline']) !!}
