                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                {!! Form::text('ngaydat', $tuychinhkg->ngaydat->format('d-m-Y'), array('placeholder' => 'Ngày','class' => 'form-control','data-toggle' => 'datepickerNgayHienTai2','autocomplete'=>'off')) !!}
                                @error('name')
...
<script type="text/javascript">
    ...
    $(function() {
        $('[data-toggle="datepickerNgayHienTai2"]').datepicker({
            format: 'dd-mm-yyyy',
            todayBtn: "linked",
